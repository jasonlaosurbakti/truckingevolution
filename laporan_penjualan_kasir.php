...
<thead> 
 <tr>
    ...
    <td width="73" align="center" bgcolor="#CCCCCC"><b>Status</b></td>
...
if($status  == "2"){
    ...
    ?></td>
    <td width="33" align="center"><a href="transaksi_penjualan_view.php?noNota=<?php echo $noNota; ?>" target="_blank"><img src="images/btn_view.png" width="20" height="20" border="0" /></a></td>
 ...
 <!-- <tr>
    ...
    <tr>
    <td align="center"><a href="export_excel.php?Format=XLS" target="_blank"><img src="images/xls_icon.png" width="55" height="18" border="0" title="Cetak ke Format HTML Excel"/></a></td>
