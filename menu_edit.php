...
if($_GET) {
	if(isset($_POST['btnSave'])){
		...
		if (trim($_POST['txtMenu'])=="") {
			$pesanError[] = "Data <b>deskripsi 1</b> tidak boleh kosong !";		
		}
		if (trim($_POST['txtMenu2'])=="") {
			$pesanError[] = "Data <b>deskripsi 2</b> tidak boleh kosong !";		
		}
		...
		if (count($pesanError)>=1 ){
			...
			$mySql  = "UPDATE menu SET nm_menu='$txtMenu',  nm_menu2='$txtMenu2', harga='$txtHarga', 
	...
	$kolomData = mysql_fetch_array($myQry);
		...
		$dataMenu2	= isset($kolomData['nm_menu2']) ?  $kolomData['nm_menu2'] : $_POST['txtMenu2'];
		$dataMenuLm2= $kolomData['nm_menu2'];
...
<form action="?page=Menu-Edit" method="post" name="form1" target="_self">
  <table width="700" class="table-list" border="0" cellspacing="1" cellpadding="4">
    <tr>
      <th colspan="3"><b>[ UBAH ] DESCRIPTION TRANSPORT</b></th>
    </tr>
    <tr>
    ...
    <tr>
	 ...
	 <tr>
      <td><b>Trip </b></td>
      <td><b>:</b></td>
      <td><input name="txtMenu2" type="text" value="<?php echo $dataMenu2; ?>" size="80" maxlength="100" />
        <input name="txtMenuLm2" type="hidden" value="<?php echo $dataMenuLm2; ?>" /></td>
    </tr>
    <tr>
      <td><b>Harga (Rp) </b></td>
      <td><b>:</b></td>
