...
<table width="100%" cellpadding="2" cellspacing="1" class="table-list" style="margin-top:0px;">
	<tr>
	  <th colspan="3">PERMINTAAN PERJALANAN</th>
	</tr>
	<tr>
	  <td>&nbsp;</td>
	  <td>&nbsp;</td>
	...
	<tr>
      <td><b>Kendaraan dan Plat No</b></td>
	  <td><b>:</b></td>
	  <td><input name="txtNoMeja" value="<?php echo $dataNoMeja; ?>" size="60" maxlength="40"/></td>
    </tr>
	<tr>
	  <td width="17%"><b>Jumlah Pegawai</b></td>
	  <td width="1%"><b>:</b></td>
	  <td width="82%"><input name="txtJumlahOrg" value="<?php echo $dataJumlahOrg; ?>" size="60" maxlength="40"/></td></tr>
	<tr>
	  <td><b>Driver</b></td>
	  <td><b>:</b></td>
	...
	<tr>
      <td><b>Tujuan Lokasi</b></td>
	  <td><b>:</b></td>
	  <td><input name="txtTelepon" value="<?php echo $dataTelepon; ?>" size="30" maxlength="30" /></td>
    </tr>
	<tr>
	...
	<tr><td>&nbsp;</td>
	  <td>&nbsp;</td>
	  <td><input type="submit" name="btnSave" value="ACCEPTED" style="cursor:pointer;"></td>
    </tr>
