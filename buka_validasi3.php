...
?>
  <tr>
    ...
    <td width="35" align="center"><a href="transaksi_penjualan_validasi3.php?noNota=<?php echo $noNota; ?>" target="_self" alt="Edit Data"><img src="images/btn_edit.png" width="20" height="20" border="0" /></a></td>
  </tr>
  <?php } ?>
    </tbody>
 <!-- <tr>
